...
const Main = () => {
  return (
    <>    
    <div id='main' className=' flex w-full h-screen text-center pt-30 md:mb-[590px] mb-[2000px] sm:mb-[940px]'>
        <div className=' flex flex-col max-w-[1240px] w-full h-auto mx-auto p-2 gap-6  justify-center items-center'>
          <div className='flex left-[50%] rounded-full w-[400px] h-[400px] mt-[2020px] sm:mt-[1080px] md:mt-[720px]'>            
